...
# ============================================================
# HEALTH CHECK SERVER - Alag PROCESS mein chalega (Render ke liye)
# Isse scraping kabhi bhi health check ko block nahi karegi
# ============================================================
...
if __name__ == "__main__":
    # Health server ko ALAG PROCESS mein chalao - isse CPU-heavy scraping
    # kabhi bhi health check response ko block nahi karegi
    health_process = multiprocessing.Process(target=run_health_server, daemon=True)
    health_process.start()
    print("🌐 Health check server started on port", os.environ.get("PORT", 10000))

    # Phir asli monitoring shuru karo (main process mein)
    run_monitor()
